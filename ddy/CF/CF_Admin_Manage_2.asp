...
<table class="tb_1">
  ...
  <tr class="tr_1"> 
    ...
    <tr>
      <td>系统皮肤：</td>
      <td><input type="radio" name="skintype" value="0"<%if rs("skintype")=0 then Response.write " checked"%> onclick="document.getElementById('skincolor').value='C9DDF0|F3F9FE';">
        默认 
...
<table class="tb_1">
            ...
            <form name="form5" method="post" action="?Action=searchmodifysave&ID=<%=ID%>">
              ...
              <tr> 
                <td colspan="4" class="td_1">如何增加或修改例子，例如你在百度上搜索网页&quot;乘风&quot;,在结果页的地址栏里的网址是http://www.baidu.com/s?wd=%B3%CB%B7%E7&amp;cl=3<br>
